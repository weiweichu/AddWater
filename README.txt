This file add water into P2VP domain according to the density of P2VP along x asis.
1. density.py give a density.txt file. This include P2VP density along x axis
